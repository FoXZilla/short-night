...
var AxisBody = /** @class */ (function (_super) {
    ...
    function AxisBody(props) {
        var _this = _super.call(this, props) || this;
        _this.name = definitions_1.SN.AxisBody;
        _this.drawInfo = {
            box: {
                x: 0,
                y: 0,
    ...
    AxisBody.prototype.createBox = function () {
        this.drawInfo.box = {
    ...
    AxisBody.prototype.apply = function () {
