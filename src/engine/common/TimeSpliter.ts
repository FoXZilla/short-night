...
export default class TimeSpliter {
     ...
     * The array returned contain Date objects passed in constructor.
     * */
    split(by :DateBy, step?:number) :Date[] {
        ...
        result.unshift(this.smaller);
        result.push(this.bigger);
